...
public class SynemaniaVisualizationFear extends SynemaniaVisualization {

	public SynemaniaVisualizationFear(PApplet viz, String className) {
		super(viz, className);
		particles = new SynemaniaFearParticle[maxFearies];
