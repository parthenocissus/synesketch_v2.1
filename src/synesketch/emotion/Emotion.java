...
public class Emotion implements Comparable<Emotion> {
	...
	public static int ANGER = 2;
	public static int FEAR = 3;	
	public static int DISGUST = 4;
	public static int SURPRISE = 5;
	public static int NEUTRAL = 6;
	
	public static String[] URI_EMOTIONS = {SemanticAnnotationUtility.EMOML + "happiness", SemanticAnnotationUtility.EMOML + "sadness",
		SemanticAnnotationUtility.EMOML + "anger", SemanticAnnotationUtility.EMOML + "fear", SemanticAnnotationUtility.EMOML + "disgust",
		SemanticAnnotationUtility.EMOML + "surprise", SemanticAnnotationUtility.WNA_NS + "neutral-emotion"};
	...
	/**
	 * Testing if emotion is negative
	 * 
	 * @param arg
	 *            {@link int} which is to be determind whether or not is negative
	 * @boolean true or false representing the result
	 */	
	public static boolean isNegative(int arg) {
		if ((arg == Emotion.SADNESS) || (arg == Emotion.ANGER) || (arg == Emotion.FEAR) || (arg == Emotion.DISGUST)) {
			return true;
		} else {
			return false;
		}
