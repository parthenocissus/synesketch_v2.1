...
public class EmpathyboxHooloovoo {
	...
	private EmpathyPanel getAppletPanel() {
		if (appletPanel == null) {
			try {
				appletPanel = new EmpathyPanel(dim, "Hooloovoo", "synesketch.emotion.SynesthetiatorEmotion");
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				EmpathyboxHooloovoo application = new EmpathyboxHooloovoo();
